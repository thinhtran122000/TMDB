...
import com.example.tmdb.databinding.ActivityListTvSeriesCastDetailsBinding
import com.example.tmdb.utils.Credentials

class ListTvSeriesCastDetailsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityListTvSeriesCastDetailsBinding
    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityListTvSeriesCastDetailsBinding.inflate(layoutInflater)
