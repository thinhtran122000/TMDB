...
import com.example.tmdb.databinding.ActivityListTvSeriesCrewDetailsBinding
import com.example.tmdb.utils.Credentials

class ListTvSeriesCrewDetailsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityListTvSeriesCrewDetailsBinding
    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityListTvSeriesCrewDetailsBinding.inflate(layoutInflater)
