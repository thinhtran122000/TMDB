...
import com.example.tmdb.databinding.ActivityNowPlayingMovieCrewDetailsBinding
import com.example.tmdb.utils.Credentials

class NowPlayingMovieCrewDetailsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityNowPlayingMovieCrewDetailsBinding
    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityNowPlayingMovieCrewDetailsBinding.inflate(layoutInflater)
