...
import com.example.tmdb.databinding.ActivityListNowPlayingMovieCastDetailsBinding //
import com.example.tmdb.utils.Credentials

class ListNowPLayingMovieCastDetailsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityListNowPlayingMovieCastDetailsBinding
    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityListNowPlayingMovieCastDetailsBinding.inflate(layoutInflater)
