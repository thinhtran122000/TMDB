...
import com.example.tmdb.databinding.ActivityTrendingMovieCastDetailsBinding
import com.example.tmdb.utils.Credentials

class TrendingMovieCastDetailsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTrendingMovieCastDetailsBinding
    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTrendingMovieCastDetailsBinding.inflate(layoutInflater)
