...
import com.example.tmdb.databinding.ActivityListTrendingMovieCrewDetailsBinding
import com.example.tmdb.utils.Credentials

class ListTrendingMovieCrewDetailsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityListTrendingMovieCrewDetailsBinding
    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityListTrendingMovieCrewDetailsBinding.inflate(layoutInflater)
